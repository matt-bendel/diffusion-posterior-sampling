        ...
        for i, data in enumerate(test_loader):
            ...
            for j in range(sample.shape[0]):
                torch.save(sample[j].detach().cpu(),
                           f'/storage/matt_models/inpainting/dps/test_20k/image_{base_im_count + j}_sample_{k}.pt')
                torch.save(mask[j].detach().cpu(),
                           f'/storage/matt_models/inpainting/dps/test_20k/image_{base_im_count + j}_mask.pt')
