...
class GaussianDiffusion:
    ...
    def p_sample_loop(self,
        ...
        for idx in pbar:
            ...
            img = self.p_sample(x=img, t=time, model=model, y=measurement, cond=True, H=svd, noise_sig=noise_sig)['sample'].detach()

            if record:
                if idx % 10 == 0:
                    file_path = f"/storage/matt_models/inpainting/pigdm/x_{str(idx).zfill(4)}.png"
