                ...
                with torch.no_grad():
                    ...
                    for damp in damping_factos:
                        ...
                        for t in t_vals:
                            ...
                            plt.figure()
                            plt.semilogy(np.arange(5), eta1s)
                            plt.semilogy(np.arange(5), eta2s)
                            plt.semilogy(np.arange(5), gam1s)
                            plt.semilogy(np.arange(5), gam2s)
                            plt.semilogy(np.arange(5), mse1s, linestyle='dashed')
                            plt.semilogy(np.arange(5), mse2s, linestyle='dashed')
