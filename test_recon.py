                ...
                with torch.no_grad():
                    ...
                    for damp in damping_factos:
                        ...
                        for t in t_vals:
                            ...
                            plt.figure()
                            plt.semilogy(np.arange(2), eta1s, color='red')
                            plt.semilogy(np.arange(2), eta2s, color='blue')
                            plt.semilogy(np.arange(2), gam1s, color='green')
                            plt.semilogy(np.arange(2), gam2s, color='orange')
                            plt.semilogy(np.arange(2), mse1s, linestyle='dashed', color='red')
                            plt.semilogy(np.arange(2), mse2s, linestyle='dashed', color='blue')
                            plt.semilogy(np.arange(2), mser1s, linestyle='dashed', color='green')
                            plt.semilogy(np.arange(2), mser2s, linestyle='dashed', color='orange')
