                ...
                with torch.no_grad():
                    ...
                    for damp in damping_factos:
                        ...
                        for t in t_vals:
                            ...
                            plt.figure()
                            plt.semilogy(np.arange(100), eta1s, color='red')
                            plt.semilogy(np.arange(100), eta2s, color='blue')
                            plt.semilogy(np.arange(100), gam1s, color='green')
                            plt.semilogy(np.arange(100), gam2s, color='orange')
