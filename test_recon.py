                ...
                with torch.no_grad():
                    ...
                    for damp in damping_factos:
                        ...
                        for t in t_vals:
                            ...
                            plt.figure()
                            plt.semilogy(np.arange(50), eta1s)
                            plt.semilogy(np.arange(50), eta2s)
                            # plt.semilogy(np.arange(25), gam1s)
                            # plt.semilogy(np.arange(25), gam2s)
                            plt.semilogy(np.arange(50), mse1s, linestyle='dashed')
                            plt.semilogy(np.arange(50), mse2s, linestyle='dashed')
