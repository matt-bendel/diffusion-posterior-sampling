                ...
                with torch.no_grad():
                    ...
                    for damp in damping_factos:
                        ...
                        for t in t_vals:
                            ...
                            _, eta1s, eta2s, gam1s, gam2s, mu1s, mu2s = vamp_model.run_vamp_reverse_test(x_t, y, torch.tensor([t]).to(x_t.device), measure_config['noise']['sigma'], measure_config["operator"]["name"], ref_img, False)
